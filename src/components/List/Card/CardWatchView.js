import { Button, ListGroupItem, ListGroup, Spinner, Card } from "react-bootstrap";

function CardWatchView({activeClass, item, photoLink, spinner, removeCard}) {
    return (
        <div className={activeClass}>
            ...
            <ListGroup className="list-group-flush">
                <ListGroupItem className="card_descr">
                    <strong className="card_descr_price">Price: </strong> {item.price}
                </ListGroupItem>
                <ListGroupItem><strong>Currency: </strong>{item.currency}</ListGroupItem> 
                
                <ListGroupItem><strong>Country: </strong>{item.country}</ListGroupItem>
            </ListGroup>
